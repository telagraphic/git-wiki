var tipuesearch = {"pages": [{
    ...
    "title": "Wiki Guide",
    "text": "Wiki Guide Overview of the UI Components, Page Layouts and How to Guide. Contact @Nick Lyons for assistance. How to Use Components to use in page layout and css instructions. UI Components CSS Guide Page Layouts There are several page layouts to meet you needs for the type of documentation you might need. Project Article UI Screen",
    "tags": "",
